...
import React, { PureComponent } from 'react'; // RENDER FIX
...
import { PanGestureHandler, TapGestureHandler, State } from 'react-native-gesture-handler'; // IGNORE THIS
...
export default class DrawerLayout extends PureComponent<PropType, StateType> { // RENDER FIX
  static defaultProps = {
    drawerWidth: 200,
    drawerPosition: 'left',
